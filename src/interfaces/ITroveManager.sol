...
interface ITroveManager /* is ILiquityBase */ {
    ...
    function lusdToken() external view returns (address /* ILUSDToken */);
    function lqtyToken() external view returns (address /* IERC20 */);
    ...
    // inherited from liquity base
    function getEntireSystemDebt(address _collateral) external view returns (uint entireSystemDebt);
    function getEntireSystemColl(address _collateral) external view returns (uint entireSystemColl);
